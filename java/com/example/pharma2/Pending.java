...
public class Pending extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.containerPend), (v, insets) -> {
            Insets systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars());
            v.setPadding(systemBars.left, systemBars.top, systemBars.right, systemBars.bottom);
            return insets;
        });

        LinearLayout c = findViewById(R.id.containerPend);
        ...
        Request request = new Request.Builder()
                .url("https://lamp.ms.wits.ac.za/home/s2543444/Orders2.php")
                .build();
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, @NonNull final Response response) throws IOException {
                ...
                try {
                    ...
                    Pending.this.runOnUiThread(new Runnable() {
                        @Override
