...
public class AvailableMedications extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String token = (mySH.getString("Token", "Default_Value"));
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, @NonNull final Response response) throws IOException {
                ...
                try {
                    ...
                    AvailableMedications.this.runOnUiThread(new Runnable() {
                        @Override
