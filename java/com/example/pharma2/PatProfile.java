...
public class PatProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pat_profile); // Link to prescriptions.xml
        ...
        String token = (mySH.getString("pToken", "Default_Value"));
        String pass = (mySH.getString("Pat Password", "Default_Value"));
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(@NonNull Call call, @NonNull IOException e) {
                runOnUiThread(() -> Toast.makeText(PatProfile.this, "Network error", Toast.LENGTH_SHORT).show());
            }

            @Override
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                if (!response.isSuccessful()) {
                    runOnUiThread(() -> Toast.makeText(PatProfile.this, "Unexpected response", Toast.LENGTH_SHORT).show());
                    return;
                }
                ...
                try {
                    ...
                    e.printStackTrace();
                    runOnUiThread(() -> Toast.makeText(PatProfile.this, "JSON parsing error", Toast.LENGTH_SHORT).show());
                }
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PatProfile.this, DocEditProfile.class);
                ...
                client.newCall(request).enqueue(new Callback() {
                    ...
                    public void onResponse(Call call, final Response response) throws IOException {
                        ...
                        try {
                            ...
                            runOnUiThread(() -> {
                                if (success == 1) {
                                    Toast.makeText(PatProfile.this, message, Toast.LENGTH_SHORT).show();
                                    //store the api key(session token so we can use it anywhere
                                    Intent intent = new Intent(PatProfile.this, MainActivity.class);
                                    startActivity(intent);
