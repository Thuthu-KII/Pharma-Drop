...
public class PatPrescriptions extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.pat_prescriptions);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.patpres), (v, insets) -> {
            Insets systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars());
            v.setPadding(systemBars.left, systemBars.top, systemBars.right, systemBars.bottom);
            return insets;
        });

        LinearLayout c = findViewById(R.id.patpres);
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, @NonNull final Response response) throws IOException {
                ...
                try {
                    ...
                    PatPrescriptions.this.runOnUiThread(new Runnable() {
                        @Override
                        ...
                        public void run() {
                            try {
                                ...
                                Toast.makeText(PatPrescriptions.this, "Cant", Toast.LENGTH_SHORT).show();
                                e.printStackTrace();
                            }
                        }
                    });
